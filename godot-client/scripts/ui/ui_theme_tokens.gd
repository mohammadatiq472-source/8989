...
const _DEFAULT_TOKEN_TABLE: Dictionary = {
	CATEGORY_PANEL: {
		"hud_top_left": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/toast_bg.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/dialog_bg.png",
			"margin": 14.0,
		},
		"hud_bottom_bar": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/bg_window_3.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/dialog_bg.png",
			"margin": 12.0,
		},
		"observability_panel": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/dialog_bg.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/toast_bg.png",
			"margin": 20.0,
		},
	},
	CATEGORY_BUTTON: {
		"refresh": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_yellow_1.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_set.png",
			"margin": 8.0,
		},
		"advance_tick": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_red_1.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_yellow_1.png",
			"margin": 8.0,
		},
		"export": {
			"texturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_set.png",
			"fallbackTexturePath": "res://assets/themes/slgclient/current/ui/hud_v1/btn_yellow_1.png",
			"margin": 8.0,
		},
	},
...
func apply_panel_style(panel: PanelContainer, category: String, token_name: String) -> bool:
	if panel == null:
		return false
	var style: StyleBoxTexture = resolve_stylebox(category, token_name)
	if style == null:
		return false
...
func apply_button_style(button: Button, token_name: String) -> bool:
	if button == null:
		return false
	var style: StyleBoxTexture = resolve_stylebox(CATEGORY_BUTTON, token_name)
	if style == null:
		return false
...
func resolve_stylebox(category: String, token_name: String) -> StyleBoxTexture:
	_ensure_loaded()
	...
	if texture == null:
		push_warning("[ui-theme-tokens] style token unresolved: %s/%s" % [category, token_name])
		return null
